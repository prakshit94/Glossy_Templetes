    ...
    <div class="p-6 lg:p-10 max-w-4xl mx-auto">
        <div class="flex items-center justify-between mb-8">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-black tracking-tight text-foreground">Edit Coupon</h1>
                    <p class="text-xs font-bold text-muted-foreground uppercase tracking-widest">{{ $coupon->code }}</p>
                </div>
            </div>
                ...
                <x-ui.card-content class="p-6 md:p-8 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="code" id="code" value="{{ old('code', $coupon->code) }}" required class="w-full h-11 px-4 rounded-xl border border-border bg-background/50 focus:bg-background text-sm font-black text-primary uppercase outline-none focus:ring-2 focus:ring-primary/20" placeholder="e.g. SUMMER50">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" step="0.01" name="value" id="value" value="{{ old('value', $coupon->value) }}" required class="w-full h-11 px-4 rounded-xl border border-border bg-background/50 focus:bg-background text-sm font-bold text-foreground outline-none focus:ring-2 focus:ring-primary/20" placeholder="e.g. 10">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" step="0.01" name="max_discount" id="max_discount" value="{{ old('max_discount', $coupon->max_discount) }}" class="w-full h-11 px-4 rounded-xl border border-border bg-background/50 focus:bg-background text-sm font-bold text-foreground outline-none focus:ring-2 focus:ring-primary/20" placeholder="e.g. 500 (Optional)">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="number" step="0.01" name="min_spend" id="min_spend" value="{{ old('min_spend', $coupon->min_spend) }}" class="w-full h-11 px-4 rounded-xl border border-border bg-background/50 focus:bg-background text-sm font-bold text-foreground outline-none focus:ring-2 focus:ring-primary/20">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" name="usage_limit" id="usage_limit" value="{{ old('usage_limit', $coupon->usage_limit) }}" class="w-full h-11 px-4 rounded-xl border border-border bg-background/50 focus:bg-background text-sm font-bold text-foreground outline-none focus:ring-2 focus:ring-primary/20" placeholder="e.g. 100 (Optional)">
                            <p class="text-[9px] text-muted-foreground ml-1 font-bold">Currently used: {{ $coupon->used_count }} times</p>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="date" name="expiry_date" id="expiry_date" value="{{ old('expiry_date', $coupon->expiry_date ? $coupon->expiry_date->format('Y-m-d') : '') }}" class="w-full h-11 px-4 rounded-xl border border-border bg-background/50 focus:bg-background text-sm font-bold text-foreground outline-none focus:ring-2 focus:ring-primary/20">
                            @error('expiry_date') <p class="text-xs text-destructive mt-1">{{ $message }}</p> @enderror
                        </div>
                    </div>

                    <div class="space-y-2 flex items-center gap-3">
                        <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $coupon->is_active) ? 'checked' : '' }} class="size-5 rounded border-border text-primary focus:ring-primary">
