                ...
                <tr class="border-b border-white/5 hover:bg-white/[0.02] transition-colors group">
                    ...
                    <td class="p-4 text-right">
                        <form action="{{ route('inventory.update', $stock) }}" method="POST" class="flex items-center justify-end gap-2">
                            ...
                            @method('PUT')
                            <div class="relative">
                                <input type="number" name="quantity" value="{{ $stock->quantity }}" class="w-24 h-9 px-3 rounded-xl border border-white/10 bg-white/5 text-center text-xs font-black focus:ring-2 focus:ring-primary/20 transition-all">
                            ...
                            <button type="submit" class="size-9 rounded-xl bg-primary text-white flex items-center justify-center hover:bg-primary/80 transition-all shadow-lg shadow-primary/20 hover:scale-105 active:scale-95">
