                ...
                <div class="p-6 border-b border-border/40 bg-muted/10">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-muted-foreground mt-0.5">Register a new customer with full contact, business and compliance details.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <x-ui.card-content class="p-8 space-y-12">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                ...
                                <div class="space-y-2 group">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="firstname" value="{{ old('firstname') }}" required placeholder="e.g. Rahul"
                                ...
                                <div class="space-y-2 group">
                                    ...
                                    <input type="text" name="middlename" value="{{ old('middlename') }}" placeholder="e.g. Kumar"
                                ...
                                <div class="space-y-2 group">
                                    ...
                                    <input type="text" name="lastname" value="{{ old('lastname') }}" required placeholder="e.g. Sharma"
                                        class="w-full px-5 py-3 rounded-2xl bg-background/40 border border-border/60 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all shadow-sm text-sm font-medium">
                                ...
                                <div class="space-y-2 group" x-data="{ 
                                    selectedSources: {{ json_encode(old('source', [])) }},
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                ...
                                <div class="space-y-2 group">
                                    ...
                                    <input type="text" name="alternatemobile" value="{{ old('alternatemobile') }}" placeholder="Secondary mobile"
                                        class="w-full px-5 py-3 rounded-2xl bg-background/40 border border-border/60 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all shadow-sm text-sm font-medium">
                                </div>
                                <div class="space-y-2 group">
                                    ...
                                    <input type="text" name="phone_number_2" value="{{ old('phone_number_2') }}" placeholder="Office/Home phone"
                                        class="w-full px-5 py-3 rounded-2xl bg-background/40 border border-border/60 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all shadow-sm text-sm font-medium">
                                </div>
                                <div class="space-y-2 group">
                                    ...
                                    <input type="text" name="relative_mobile" value="{{ old('relative_mobile') }}" placeholder="Emergency contact name"
                                        class="w-full px-5 py-3 rounded-2xl bg-background/40 border border-border/60 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all shadow-sm text-sm font-medium">
                                </div>
                                <div class="space-y-2 group">
                                    ...
                                    <input type="text" name="relative_phone" value="{{ old('relative_phone') }}" placeholder="Emergency contact phone"
                                        class="w-full px-5 py-3 rounded-2xl bg-background/40 border border-border/60 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all shadow-sm text-sm font-medium">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="space-y-2 group md:col-span-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="company_name" value="{{ old('company_name') }}" placeholder="Full legal company name"
                                            class="w-full pl-11 pr-4 py-3 rounded-2xl bg-background/40 border border-border/60 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all shadow-sm text-sm font-medium">
                                    </div>
                                </div>
                                <div class="space-y-2 group">
                                    ...
                                    <input type="text" name="gst_no" value="{{ old('gst_no') }}" placeholder="22AAAAA0000A1Z5"
                                ...
                                <div class="space-y-2 group">
                                    ...
                                    <input type="text" name="pan_no" value="{{ old('pan_no') }}" placeholder="AAAAA0000A"
                                        class="w-full px-5 py-3 rounded-2xl bg-background/40 border border-border/60 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all shadow-sm text-sm font-mono uppercase tracking-widest">
                                </div>
                                <div class="space-y-2 group">
                                    ...
                                    <input type="text" name="aadhaar_last4" value="{{ old('aadhaar_last4') }}" maxlength="4" placeholder="XXXX"
                                ...
                                <div class="flex items-center gap-6 pt-4">
                                    <label class="flex items-center gap-3 cursor-pointer group/toggle">
                                        ...
                                        <input type="checkbox" name="kyc_completed" value="1" {{ old('kyc_completed') ? 'checked' : '' }}
                                    ...
                                    <label class="flex items-center gap-3 cursor-pointer group/toggle">
                                        ...
                                        <input type="checkbox" name="is_blacklisted" value="1" {{ old('is_blacklisted') ? 'checked' : '' }}
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div class="space-y-2 group">
                                    ...
                                    <div class="flex gap-3">
                                        <input type="number" name="land_area" value="{{ old('land_area') }}" min="0" step="0.01" placeholder="0.00"
                                        ...
                                        <select name="land_unit" class="w-1/3 px-4 py-3 rounded-2xl bg-background/40 border border-border/60 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all shadow-sm text-xs font-bold text-foreground">
                                            ...
                                            @foreach($landUnits as $unit)
                                                <option value="{{ $unit->name }}" {{ old('land_unit') === $unit->name ? 'selected' : '' }}>{{ $unit->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-2 group" x-data="{ 
                                    selectedIrrigation: {{ json_encode(old('irrigation_type', [])) }},
                                ...
                                <div class="space-y-3 md:col-span-2" x-data="{ 
                                    selectedCrops: {{ json_encode(old('crops', [])) }},
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                ...
                                <div class="space-y-2 group">
                                    <label class="text-[10px] font-black uppercase tracking-[0.15em] text-muted-foreground group-focus-within:text-primary transition-colors">Initial Balance (₹)</label>
                                    <input type="number" name="outstanding_balance" value="{{ old('outstanding_balance', 0) }}" step="0.01"
                                        class="w-full px-5 py-3 rounded-2xl bg-background/40 border border-border/60 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all shadow-sm text-sm font-medium">
                                </div>
                                <div class="space-y-2 group">
                        ...
                        <div class="pt-4">
                            ...
                            <textarea name="internal_notes" rows="4" placeholder="Add private administrative notes, customer history, or special handling instructions here..."
                                class="w-full px-6 py-4 rounded-3xl bg-background/40 border border-border/60 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all shadow-sm text-sm font-medium resize-none placeholder:text-muted-foreground/60">{{ old('internal_notes') }}</textarea>
                        </div>
                    </x-ui.card-content>

                    <div class="p-8 bg-muted/20 border-t border-border/40 flex items-center justify-between">
                        <a href="{{ route('customers.index') }}" class="text-xs font-bold uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors">Cancel & Return</a>
                        <x-ui.button type="submit" class="rounded-2xl px-8 py-6 shadow-xl shadow-primary/20">
