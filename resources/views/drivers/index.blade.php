                                ...
                                <x-slot name="content">
                                    ...
                                    <div class="p-1 space-y-1">
                                        <template x-if="filter !== 'trashed'">
                                            <div class="space-y-1">
                                                <form action="{{ route('drivers.bulk-delete') }}" method="POST" onsubmit="return confirm('Move selected drivers to archive?')">
                                                    @csrf
                                        ...
                                        <template x-if="filter === 'trashed'">
                                            <div class="space-y-1">
                                                <form action="{{ route('drivers.bulk-restore') }}" method="POST">
                                                    @csrf
                                                    <input type="hidden" name="ids" :value="JSON.stringify(selectedRecords)">
                                                ...
                                                <form action="{{ route('drivers.bulk-force-delete') }}" method="POST" onsubmit="return confirm('PERMANENTLY delete selected drivers?')">
                                                    @csrf
                                                    <input type="hidden" name="ids" :value="JSON.stringify(selectedRecords)">
                                                    <button type="submit" class="w-full text-left px-3 py-2 text-[10px] font-black hover:bg-destructive/10 rounded-xl flex items-center text-destructive uppercase tracking-widest transition-colors">
