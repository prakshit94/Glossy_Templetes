            ...
            <x-ui.card-header class="border-b border-border/40 bg-muted/10 p-8">
                <div class="flex items-center gap-6">
                    <div class="size-16 rounded-2xl bg-gradient-to-tr from-primary/20 to-primary/5 border border-primary/10 text-primary flex items-center justify-center shadow-inner">
                        <x-ui.icon name="plus-circle" size="8" />
                    </div>
                    <div>
                        <h3 class="text-2xl font-black tracking-tight text-foreground">Service Details</h3>
                        <p class="text-sm text-muted-foreground">Define a new logistical service for your delivery network.</p>
                    </div>
                </div>
            </x-ui.card-header>
            ...
            <x-ui.card-content class="p-8">
                <form action="{{ route('services.store') }}" method="POST" class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="name" required placeholder="e.g. Express Delivery"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="code" required placeholder="e.g. EXP"
                                    class="w-full pl-12 pr-4 py-3 rounded-2xl border border-border bg-background/50 focus:bg-background transition-all outline-none focus:ring-2 focus:ring-primary/20 text-foreground placeholder:text-muted-foreground/40">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            <textarea name="description" rows="4" placeholder="Briefly describe what this service provides..."
                                class="w-full p-4 rounded-2xl border border-border bg-background/50 focus:bg-background transition-all outline-none focus:ring-2 focus:ring-primary/20 resize-none text-foreground placeholder:text-muted-foreground/40"></textarea>
                        </div>
                    </div>

                    <div class="flex items-center gap-3 p-4 rounded-2xl bg-primary/5 border border-primary/10">
                        <input type="checkbox" name="is_active" id="is_active" value="1" checked class="rounded border-border text-primary focus:ring-primary/20 size-5 bg-background/50">
                        <label for="is_active" class="text-sm font-bold text-foreground cursor-pointer">Activate service immediately</label>
                    </div>
