        ...
        <x-ui.card class="border-border/40 shadow-2xl bg-white/[0.03] dark:bg-white/[0.02] backdrop-blur-2xl rounded-3xl overflow-hidden">
            <x-ui.card-header class="border-b border-white/10 bg-white/[0.02] p-8">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <h3 class="text-2xl font-black tracking-tight">Service Details</h3>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            <textarea name="description" rows="4" placeholder="Briefly describe what this service provides..."
                                class="w-full p-4 rounded-2xl border border-border/50 bg-background/50 focus:bg-background transition-all outline-none focus:ring-2 focus:ring-primary/20 resize-none"></textarea>
                        </div>
                    </div>

                    <div class="flex items-center gap-3 p-4 rounded-2xl bg-primary/5 border border-primary/10">
                        <input type="checkbox" name="is_active" id="is_active" value="1" checked class="rounded border-border text-primary focus:ring-primary/20 size-5">
