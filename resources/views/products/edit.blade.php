                            ...
                            <div class="space-y-6">
                                <div class="p-6 rounded-3xl bg-muted/10 border border-border/40 space-y-6 shadow-sm">
                                    ...
                                    <div class="grid grid-cols-1 gap-4 pt-2">
                                        ...
                                        <div class="space-y-2" x-data="{ discType: '{{ old('default_discount_type', $product->default_discount_type ?? 'percent') }}' }">
                                            ...
                                            <div class="flex gap-2">
                                                ...
                                                <div class="relative flex-1">
                                                    ...
                                                    <input type="number" step="0.01" name="default_discount" id="default_discount" min="0"
                                                        ...
                                                        value="{{ old('default_discount', $product->default_discount) }}"
