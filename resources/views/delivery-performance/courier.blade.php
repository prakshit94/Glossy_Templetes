<x-layouts.app pageTitle="Courier Performance">
    <div class="p-6 lg:p-10 max-w-[1920px] mx-auto w-full space-y-8">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h1 class="text-3xl font-black tracking-tight">{{ $provider }}</h1>
                <p class="text-[11px] font-bold uppercase tracking-widest text-muted-foreground mt-2">Courier provider performance and associated orders</p>
            </div>
