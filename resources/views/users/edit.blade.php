                            ...
                            <div class="space-y-2 group">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="bio" rows="1"
                                        ...
                                        class="w-full pl-10 pr-4 py-2.5 rounded-xl bg-background/50 border border-border focus:bg-background focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all shadow-sm text-foreground resize-none">{{ old('bio', $user->bio) }}</textarea>
                                </div>
